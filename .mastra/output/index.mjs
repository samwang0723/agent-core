...
import { w as weatherWorkflowWithSuspend } from './weather.mjs';
import { l as logger$1 } from './logger.mjs';
import { registerApiRoute } from '@mastra/core/server';
import { AgentNetwork } from '@mastra/core/network';
import { openai, createOpenAI } from '@ai-sdk/openai';
import { Agent } from '@mastra/core/agent';
import { toolRegistry } from './tools/57ea4bf5-1917-4e26-85fc-a6f7f033fd6b.mjs';
...
import 'winston';
import './tools/92bc2908-9d94-49ad-a4c4-06102fe95d05.mjs';
import './tools/b8d0f762-f904-4d94-9122-ab95817ff1e7.mjs';
import './tools/8a02bc6f-832c-407d-a841-caa763907fb4.mjs';
import './tools/d52b35fe-d81f-4d7f-95fb-b0a582c91a9e.mjs';
...
var AuthFlow = class {
  ...
  async getTokenFromCode() {
    ...
    if ("error" in response) {
      throw new HTTPException$1(400, { message: response.error_description });
    }
  ...
  async getUserData() {
    ...
    if ("error" in response) {
      throw new HTTPException$1(400, { message: response.error?.message });
    }
    if ("id" in response) {
      this.user = response;
    }
...
const mastra = new Mastra({
  ...
  server: {
    ...
    middleware: [
      ...
      async (c, next) => {
        logger$1.debug(`${c.req.method} ${c.req.url}`);
        await next();
      }
    ],
